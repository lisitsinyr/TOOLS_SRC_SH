...
#beginfunction
    ...
    if N:
        ...
        try:
            ...
            GINIFileName = "/d/PROJECTS_LYR/CHECK_LIST/01_OS/03_UNIX/PROJECTS_UNIX/TOOLS_SRC_SH/REPO.ini"
            GINIFileName = r"d:\PROJECTS_LYR\CHECK_LIST\01_OS\03_UNIX\PROJECTS_UNIX\TOOLS_SRC_SH\REPO.ini"
        #endtry
        try:
            GSection = sys.argv[2]
        except IndexError as ERROR:
